...
If you are also running BuddyPress with BuddyX Pro, WP Career Board can surface job board activity in BuddyPress activity streams and member profiles. See [BuddyPress Integration](./buddypress.md) for details.
