...
| T22a | JS: Replace window.confirm/prompt with styled modal; pass reason to reject endpoint; show reason on job edit | ✅ 2026-03-16 · `467b218` |
| T22b | Applications: bulk status change (Reviewing/Shortlisted/Rejected/Hired) | ✅ 2026-03-16 · `467b218` |
| T22c | Companies: trust_level column + inline change action | ✅ 2026-03-16 · `467b218` |
| T22d | JS: Loading states on status select (disable + spinner during REST call) | ✅ 2026-03-16 · `467b218` |
