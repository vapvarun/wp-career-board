...
> D rows are sourced from the last 30 git commits (2026-05-09 audit) and updated after every customer-visible fix. After 2 clean releases, a D row graduates into C/E.
