...
- `bin/seed-qa-fixtures.php` — idempotent reseeder (uses verified v1.1.0 meta keys + Pro table schemas; not normally needed since jobboard.local already has 9 jobs / 35 applications / 9 companies / 7 resumes from prior dev)
