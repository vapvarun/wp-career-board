...
8. **Candidates list.** Navigate to `$WCB_SITE/wp-admin/admin.php?page=wcb-candidates&autologin=varundubey` → expect HTTP 200 and the Candidates list table (`AdminCandidates::render()`) rendering with no PHP error.
