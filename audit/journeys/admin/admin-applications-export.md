...
4. Verify the CSV has a header line: inspect first line of the response body → expect comma-separated column names (e.g. `user_id`, `amount`, `entry_type`, `created_at` or similar schema from `wcb_credit_ledger`)
