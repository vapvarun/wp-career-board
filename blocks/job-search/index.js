( function () {
	...
	var BLOCK_NAME = 'wp-career-board/job-search';

	wp.blocks.registerBlockType( BLOCK_NAME, {
		edit: function () {
			// block.json title/description are registered server-side and already
			// translated by core via the block textdomain. Read them back instead
			// of duplicating the literals here.
