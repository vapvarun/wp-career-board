( function () {
	...
	var BLOCK_NAME = 'wp-career-board/job-filters';

	wp.blocks.registerBlockType( BLOCK_NAME, {
		edit: function () {
			// Title/description come from block.json and are already translated
			// by core via the block's textdomain. Never re-declare them here.
